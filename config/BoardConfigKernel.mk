...
TOOLS_PATH_OVERRIDE += \
    PATH=$(BUILD_TOP)/prebuilts/clang/host/linux-x86/clang-11/bin:$(BUILD_TOP)/prebuilts/tools-extras/$(HOST_OS)-x86/bin:$$PATH \
    LD_LIBRARY_PATH=$(BUILD_TOP)/prebuilts/clang/host/linux-x86/clang-11/lib:$(BUILD_TOP)/prebuilts/tools-extras/$(HOST_OS)-x86/lib:$$LD_LIBRARY_PATH \
